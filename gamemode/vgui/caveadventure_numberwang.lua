...
function PANEL:Init()
	...
	self:SetBackColor( CAVEADVENTURE.FUNC.GetTheme( 2, 100 ) )
	self:SetHighlightColor( CAVEADVENTURE.FUNC.GetTheme( 2 ) )
...
vgui.Register( "caveadventure_numberwang", PANEL, "DPanel" )