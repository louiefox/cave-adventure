...
function PANEL:CreateTextEntry()
	...
	self.textEntry = vgui.Create( "caveadventure_textentry", self )
...
function PANEL:Paint( w, h )
	...
	draw.RoundedBoxEx( (self.cornerRadius or 8), (self.roundedBoxX or 0), (self.roundedBoxY or 0), (self.roundedBoxW or w), (self.roundedBoxH or h), (self.backColor or CAVEADVENTURE.FUNC.GetTheme( 2, 100 )), true, true, roundBottom, roundBottom )

	surface.SetAlphaMultiplier( (alpha/255)/2 )
	draw.RoundedBoxEx( (self.cornerRadius or 8), (self.roundedBoxX or 0), (self.roundedBoxY or 0), (self.roundedBoxW or w), (self.roundedBoxH or h), (self.highlightColor or CAVEADVENTURE.FUNC.GetTheme( 2 )), true, true, roundBottom, roundBottom )
	surface.SetAlphaMultiplier( 1 )

	draw.SimpleText( (self.text or "None"), "MontserratMedium20", w/2, h/2, CAVEADVENTURE.FUNC.GetTheme( 4, 20+(not self:IsMenuOpen() and 235*(alpha/255) or 0) ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end

derma.DefineControl( "caveadventure_combosearch", "", PANEL, "DButton" )
